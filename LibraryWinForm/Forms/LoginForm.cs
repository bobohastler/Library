...
public partial class LoginForm : Form
{
    ...
    private void btnConfirm_Click(object sender, EventArgs e)
    {
        ...
        Close();
        var User = context.UserTypes.SingleOrDefault(ut => ut.Name == "User");
        var Librarian = context.UserTypes.SingleOrDefault(ut => ut.Name == "Librarian");
        if (user.UserTypeEntity == Librarian)
        {
            LibrarianForm lb = new(user);
            lb.ShowDialog();
        }
    }
}